"""Entry-owned implementation for the NSPL GUI surface.

This module preserves the current GUICLI command grammar and behavior while
moving the implementation under Entry.  ``Core.NSPL.GUICLI.guicli`` remains a
...
from Core.NSPL.GUICLI.errors import DuplicateGUIError, GUICLIError, GUINotFound, InvalidGUI
from Core.NSPL.GUICLI.loader import discover_guis, resolve_gui
