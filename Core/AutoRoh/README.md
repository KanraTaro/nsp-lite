...
`dst_director` is the first concrete profile/toolkit pairing. It carries DST-specific prompt guidance and command cooldowns outside the generic AutoRoh loop.
